...
class HistoryPanel(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        eyebrow = QLabel("Saved Chats", self)
        ...
        self.collapse_btn.setToolTip("Hide history panel")
        ...
        body = QLabel("Reopen previous chats or remove history you no longer need.", self)
    ...
    def set_sessions(self, sessions: Sequence[SessionSummary]) -> None:
        ...
        self.count_label.setText(f"{self.list.count()} saved chats")
